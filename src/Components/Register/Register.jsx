...
function handleLogin() {
 ...
 setuserLogin(JSON.parse(localStorage.getItem("userData")));
  ...
  let validationSchema = yup.object().shape({
    name: yup.string().min(3, "not valid name").required("name is required"),
    email: yup
      .string()
    ...
    phone: yup
      .string()
      .matches(/^01(1|2|0)[0-9]{8}$/, "Phone must be digits only")
            ...
            >
              ...
              <div className="relative z-0 w-full mb-5 group">
                ...
                <label
                  ...
                  className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-[#6C45D1] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                  Confirm your password
                </label>

                {formik.errors.repassword && formik.touched.repassword && (
                  <div className="p-4 mb-4 text-sm text-red-800 rounded-sm bg-red-50">
                    <span className="font-medium">
              ...
              <div className=" font-semibold mt-8 mb-4 text-sm">
                <input
                  checked
                  id="checked-checkbox"
                  type="checkbox"
              ...
              <div className="other-sign">
                ...
                <ul className="icons flex justify-center gap-x-4">
              ...
              <p className="text-slate-600 text-xs text-center font-meduim my-7">
                ...
                <span className="text-[#6C45D1] underline">our Terms </span>of
                Use and{" "}
                <span className="text-[#6C45D1] underline">
                  Privacy Policy.
                </span>
              </p>
